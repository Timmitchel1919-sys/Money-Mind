...
export const OPENAI_VOICES = [
  { id: "cedar", label: "Cedar", description: "Calm, authoritative executive voice — a JARVIS-style default" },
  { id: "marin", label: "Marin", description: "Warm, patient, supportive coach voice" },
  { id: "onyx", label: "Onyx", description: "Deep, resonant male voice, deliberate JARVIS-style delivery — the deepest voice available" },
...
export const DEFAULT_OPENAI_VOICE = "cedar"
